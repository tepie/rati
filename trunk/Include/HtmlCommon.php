<?php
	...
	*/
	function commonSessionSetup(){
		...
		global $url_rest_custom_image_category_show;
		global $_SESSION;
		...
		// set the category show flag
		// set the image direction
		if(!isset($_SESSION["$url_rest_custom_image_category_show"])){
			$_SESSION["$url_rest_custom_image_category_show"] = "False";
		}
	...
	*/
	...
	function commonHtmlPlainHeader(){
		...
		$html = "";
		$html = $html . commonJumpToLink();
		$html = $html . "<div class=\"top-bar-full-about\"><br />";
	...
	*/
	...
	function commonJumpToLink(){
		global $web_app_jump_to_title;
		global $web_app_jump_to_url;
		
		$html = "";
		//$html = $html . "<small><p style=\"text-align:right;\"><a href=\"$web_app_jump_to_url\">";
		//$html = $html . "$web_app_jump_to_title</a></p></small>";
