...
<!--
<div class="about_section_heading">Upload XML File</div>
<div class="about_section_content">
<br />
By uploading an XML document that abides by the Ab Initio Import schema,
you can upload it here. How do you get a document in this format? Write
a transformation application to convert your data into this structure. This will 
likely require assistance, so please ask for help or look for examples.
<br /><br />
It is suggested that you upload small documents to accomidate load processing. The
max file size allowed for this upload process is 10000000 bytes.
<br /><br />
	<form enctype="multipart/form-data" action="Import.php" method="POST">
	<input type="hidden" name="MAX_FILE_SIZE" value="10000000" />
	Choose a file to upload: <input name="import_file_upload" type="file" /><br /><br />
