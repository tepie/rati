<?php
	...
	$relationship_reference_neighbors 	= 'select result.'.$relationship_structure_reference_fk.',attr.'.$attribute_structure_name.' from (select '.$relationship_structure_attribute_fk.','.$relationship_structure_reference_fk.' from '.$relationship_structure_table_name.' use index ('.$relationship_structure_index_object.','.$relationship_structure_index_reference.') where '.$relationship_structure_object_fk.' = %s and '.$relationship_structure_reference_fk.' != 0) as result,('.$attribute_select_all.') as attr where result.'.$relationship_structure_attribute_fk.' = attr.'.$attribute_structure_primary_id.' and attr.'.$attribute_structure_name.' != "arulesOID" limit %s';
