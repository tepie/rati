...
/**
 * A metadata object.
 * A metadata object tracks annotations and references about itself.
 * Annotations being textual, and references being pointers to other
 * metadata. Each metadata object has its own URI. 
 * @author pietrti
 *
 */
public class Metadata {
	 ...
	 * @param value The value of the annotation
	 */
	public void removeAnno(String rule, String value){
		if(this.hasAnnoValue(rule, value)){
	 ...
	 */
	public void removeRef(String rule, String uriTo) {
